...
def build_bundle(bundle_dir: Path) -> None:
    ...
    code_files = [
        ...
        REPO_ROOT / "training" / "train_hdrl.py",
        REPO_ROOT / "training" / "train_morl_surrogate.py",
        REPO_ROOT / "training" / "finetune_morl_boptest.py",
        REPO_ROOT / "training" / "run_morl_surrogate_pipeline.py",
        ...
        REPO_ROOT / "evaluation" / "yearly_validation_morl.py",
        REPO_ROOT / "evaluation" / "yearly_validation_hdrl.py",
    ...
    output_dirs = [
        ...
        REPO_ROOT / "outputs" / "block2_hdrl_hybrid_v3_v35_l000",
        REPO_ROOT / "outputs" / "block2_thermostatic_warmstart_utility",
        REPO_ROOT / "outputs" / "morl_hybrid_v3_v35_power_only_500k",
        REPO_ROOT / "outputs" / "morl_hybrid_v3_v35_power_only_17d",
    ...
    report_files = [
        ...
        REPO_ROOT / "reports" / "block2_hdrl_lambda_sweep_report.md",
