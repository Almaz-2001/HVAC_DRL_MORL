...
- The current article structure is explicitly aligned with Hou and Evins (2024), as summarized in [main_Article/_lit_review.txt](C:/Users/user/Desktop/HVAC_DRL_MORL/main_Article/_lit_review.txt).
- The compact mapping from Literature review to our Block 1 and Block 2 evidence is maintained in [literature_review_alignment_block1_block2.md](C:/Users/user/Desktop/HVAC_DRL_MORL/reports/literature_review_alignment_block1_block2.md).
- Block 1 corresponds to surrogate sample generation, data processing, training, and validation.
- Block 2 corresponds to downstream numerical justification across controller families.
- Block 3 should test cross-case transferability after these conclusions are frozen.
