...
ARTIFACTS: tuple[Artifact, ...] = (
    ...
    Artifact("reports/block2_hdrl_lambda_sweep_report.md", "docs/block2_hdrl_lambda_sweep_report.md", "docs"),
    Artifact("reports/block2_morl_canonical_report.md", "docs/block2_morl_canonical_report.md", "docs"),
    Artifact("reports/literature_review_alignment_block1_block2.md", "docs/literature_review_alignment_block1_block2.md", "docs"),
    Artifact("reports/q1_article_full_progress_report.md", "docs/q1_article_full_progress_report.md", "docs"),
    Artifact("reports/hou_evins_compliance_matrix.md", "docs/hou_evins_compliance_matrix.md", "docs"),
    Artifact("reports/hou_evins_q1_gap_closure.md", "docs/hou_evins_q1_gap_closure.md", "docs"),
    ...
    Artifact("reports/next_steps.md", "docs/next_steps.md", "docs"),
    ...
    Artifact("reports/block2_hdrl_lambda_sweep_summary.csv", "tables/block2_hdrl_lambda_sweep_summary.csv", "tables"),
    Artifact("reports/block2_morl_comparison_summary.csv", "tables/block2_morl_comparison_summary.csv", "tables"),
    Artifact("reports/hou_evins_training_hyperparams_table.csv", "tables/hou_evins_training_hyperparams_table.csv", "tables"),
    Artifact("reports/hou_evins_scaling_table.csv", "tables/hou_evins_scaling_table.csv", "tables"),
    Artifact("reports/hou_evins_input_independence_table.csv", "tables/hou_evins_input_independence_table.csv", "tables"),
    Artifact("reports/hou_evins_predictive_validity_table.csv", "tables/hou_evins_predictive_validity_table.csv", "tables"),
    Artifact(
    ...
    Artifact(
        "outputs/morl_hybrid_v3_v35_power_only_17d/seed42/finetune_boptest/models/ppo_model.zip",
        "models/ppo_morl_hybrid_power_only_17d_finetuned.zip",
        "models",
    ),
)
