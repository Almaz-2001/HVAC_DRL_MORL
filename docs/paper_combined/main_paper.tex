...
$\tau_k$ & -- & pre-registered pass threshold $1.25\,m_{s,\mathrm{PI},k}$ \\
...
$\mathcal{A}_k$ & -- & pre-registered actuator adapter \\[2pt]
...
calibration \citep{Bacher2011RCIdentification}, and the identifiability of $\Czon$
